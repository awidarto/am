...
class TrailController extends AdminController {
...
'zip' => '40235',
        */
        ...
        $this->heads = array(
            ...
            array('Change',array('search'=>true,'sort'=>true))
        );
    ...
    public function postIndex()
    {
        ...
        $this->fields = array(
            array('historyTimestamp',array('kind'=>'datetime','query'=>'like','pos'=>'both','show'=>true)),
            array('historyObjectType',array('kind'=>'text','query'=>'like','pos'=>'both','show'=>true)),
            array('historyAction',array('kind'=>'text','query'=>'like','pos'=>'both','show'=>true))
        );

        $this->def_order_by = 'historyTimestamp';
